/*
  # Add Obligation Assignment to Events

  1. Changes
    - Add `obligation_id` column to `sponsor_events` table to link events to specific obligations
  ...
  2. Notes
    ...
    - Events without an obligation_id are not counted toward any specific obligation
*/
